...
export const initializeDatabase = () => {
  ...
  // Initialize the migration manager with our database connection
  ...
  // Run migrations
  const migrationsApplied = migrationManager.migrateUp();
  console.log(`Applied ${migrationsApplied} migrations`);
