...
export function Chat() {
  ...
  useEffect(() => {
    ...
    const handleMessage = (conversationId: string, message: Message) => {
  ...
  const handleNewMessage = async (
    ...
    setCurrentConversation((prev) => {
      ...
      const updatedConversation = {
        ...prev,
        messages: [...prev.messages, newUserMessage(message)],
        updatedAt: Date.now(),
      };
      // Update in DB
      window.conversations.update(updatedConversation).catch((err) => {
